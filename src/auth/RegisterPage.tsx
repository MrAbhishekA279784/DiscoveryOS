...
import { Mail, Lock, Eye, EyeOff, UserPlus, AlertCircle, Loader2, ArrowLeft } from 'lucide-react';
        ...
        <div className="glass-panel rounded-3xl border-white/5 p-8 flex flex-col gap-7 relative overflow-hidden">
          ...
          <div className="flex flex-col items-center gap-3 relative z-10">
            ...
            <div className="flex flex-col items-center gap-1">
              ...
              <span className="text-[10px] font-mono text-zinc-500 tracking-widest uppercase">Create Account</span>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4 relative z-10">
            ...
            <div className="flex flex-col gap-1.5">
              <label className="text-[10px] font-mono tracking-widest text-zinc-400 uppercase font-bold">Confirm Password</label>
              <div className="relative">
                <Lock className="absolute left-3.5 top-1/2 -translate-y-1/2 w-4 h-4 text-zinc-500 pointer-events-none" />
                <input
                  type={showPassword ? 'text' : 'password'}
