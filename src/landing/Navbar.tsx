    ...
    <nav ref={navRef} className="fixed top-0 left-0 right-0 z-50 transition-all duration-300 py-4 px-6">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          <a href="https://github.com/MrAbhishekA279784/DiscoveryOS" target="_blank" rel="noopener noreferrer" className="hidden sm:flex items-center gap-1.5 text-xs text-zinc-400 hover:text-white transition-colors font-medium">
